        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <form onSubmit={handleSubmit} className="flex items-center">
            <input
              ...
              className="flex-1 p-2 bg-transparent border border-black text-black rounded-l-lg focus:outline-none"
            ...
            {isGenerating ? (
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="p-2 bg-transparent border border-black text-black rounded-r-lg hover:bg-white hover:bg-opacity-20 focus:outline-none disabled:bg-gray-500"
              >
