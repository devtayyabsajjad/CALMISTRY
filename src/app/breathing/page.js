...
export default function Breathing() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-transparent text-black p-4">
      <h1 className="text-4xl font-bold mb-8">Calmistry Breathing Exercise</h1>
      ...
      <div className={`relative flex items-center justify-center w-64 h-64 ${containerClass}`}
        ...
        <div className="absolute w-full h-full bg-gray-800 bg-opacity-30 rounded-full"></div>
        <div className="absolute w-56 h-56 bg-gray-700 bg-opacity-30 rounded-full"></div>
        <div className="absolute w-48 h-48 bg-gray-600 bg-opacity-30 rounded-full"></div>
        <div className="absolute w-40 h-40 bg-gray-500 bg-opacity-30 rounded-full"></div>
